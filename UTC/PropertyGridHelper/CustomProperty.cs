namespace UTC
{
    ...
    public class CustomProperty
    {
        ...
        protected bool bIsMuliSelect = true;
        ...
        protected string sSigleQuoted = "";
        protected string sDoubleQuoted = "";
        ...
        public void RebuildAttributes()
        {
            ...
            {
                if (enStyle == EditorType.CheckedListBox)
                    BuildAttributes_CheckedListboxEditor();
                else if (enStyle == EditorType.ListBox)
                    BuildAttributes_ListboxEditor();
                else if (EditorStyle == EditorType.DialogForm)
                    BuildAttributes_DialogEditor();
            }
        ...
        private void BuildAttributes_CheckedListboxEditor()
        {
            if (oDatasource != null)
            {
                UICheckedListboxEditor.UICheckedListboxDatasource ds = new UICheckedListboxEditor.UICheckedListboxDatasource(ref oDatasource);
                UICheckedListboxEditor.UICheckedListboxValueMember vm = new UICheckedListboxEditor.UICheckedListboxValueMember(sValueMember);
                UICheckedListboxEditor.UICheckedListboxDisplayMember dm = new UICheckedListboxEditor.UICheckedListboxDisplayMember(sDisplayMember);
                UICheckedListboxEditor.UICheckedListboxIsDropDownResizable ddr = null;
                ArrayList attrs = new ArrayList();
                attrs.Add(ds);
                attrs.Add(vm);
                attrs.Add(dm);
                if (bIsDropdownResizable)
                {
                    ddr = new UICheckedListboxEditor.UICheckedListboxIsDropDownResizable();
                    attrs.Add(ddr);
                }
                Attribute[] attrArray;
                attrArray = (System.Attribute[])attrs.ToArray(typeof(Attribute));
        ...
        private void BuildAttributes_DialogEditor()
        {
            if (oDatasource != null)
            {
                UIDialogEditor.UIDialogEditorDatasource ds = new UIDialogEditor.UIDialogEditorDatasource(ref oDatasource);
        ...
        [Category("Appearance"), DescriptionAttribute("Indicates if the order of property.")]
        ...
        public string  SingleOrDouble
        {
            get
            {
                return sSingleOrDouble;
            }
            set
            {
                sSingleOrDouble  = value;
            }
        }
    
        private string _Cols = "";
        [Category("DialogForm"), DescriptionAttribute("Indicates Column Header field of dialog"), XmlElementAttribute(IsNullable = false)]
        [Browsable(false)]
        ...
        [Category("DialogForm"), DescriptionAttribute("Indicates Column Header Caption field of dialog"), XmlElementAttribute(IsNullable = false)]
        [Browsable(false)]
        public string ColumnCaps
        {
            get
            {
                return _Caps;
        ...
        [Category("DialogForm"), DescriptionAttribute("Returns Single Quoted List of selected Rows"), XmlElementAttribute(IsNullable = false)]
        [Browsable(false)]
        ...
        [Category("DialogForm"), DescriptionAttribute("Returns Double Quoted List of selected Rows"), XmlElementAttribute(IsNullable = false)]
        [Browsable(false)]
        public string DoubleQuoted
        {
            get
            {
                return sDoubleQuoted;
            }
            set
            {
                sDoubleQuoted = value;
        ...
        [Category("DialogForm"), DescriptionAttribute("Indicates the Type of editor."), XmlElementAttribute(IsNullable = false)]
        public EditorType EditorStyle
        {
            get
            {
                return enStyle;
        ...
        [Category("Behavior"), DescriptionAttribute("Indicates the CheckedListbox selected value list."), XmlElementAttribute(IsNullable = false)]
        [Browsable(false)]
        public string SeletedValueMembers
        {
            get
            {
                return _selected;
        ...
        public object Datasource
        {
            ...
            {
                oDatasource = value;
                if (EditorStyle == EditorType.CheckedListBox)
                    BuildAttributes_CheckedListboxEditor();
                else if (EditorStyle == EditorType.ListBox)
                    BuildAttributes_ListboxEditor();
                else if (EditorStyle == EditorType.DialogForm)
                    BuildAttributes_DialogEditor();
            }
        ...
        public bool IsMultiSelect
        {
            get
            {
                return bIsMuliSelect;
            }
            set
            {
                bIsMuliSelect = value;
                if (EditorStyle == EditorType.DialogForm)
                    BuildAttributes_DialogEditor();                
            }
        }
        ...
        public class CustomPropertyDescriptor : PropertyDescriptor
        {
            ...
            public override string DisplayName
            {
                get
                {
                    return oCustomProperty.DisplayName;
                }
            }
